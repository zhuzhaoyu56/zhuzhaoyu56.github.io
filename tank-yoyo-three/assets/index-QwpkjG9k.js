...
#define LOW_PRECISION`),e}const U_={[Es]:"SHADOWMAP_TYPE_PCF",[Ms]:"SHADOWMAP_TYPE_VSM"};function F_(s){return U_[s.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const O_={[yi]:"ENVMAP_TYPE_CUBE",[Ki]:"ENVMAP_TYPE_CUBE",[Br]:"ENVMAP_TYPE_CUBE_UV"};function B_(s){return s.envMap===!1?"ENVMAP_TYPE_CUBE":O_[s.envMapMode]||"ENVMAP_TYPE_CUBE"}const k_={[Ki]:"ENVMAP_MODE_REFRACTION"};function z_(s){return s.envMap===!1?"ENVMAP_MODE_REFLECTION":k_[s.envMapMode]||"ENVMAP_MODE_REFLECTION"}const V_={[vh]:"ENVMAP_BLENDING_MULTIPLY",[td]:"ENVMAP_BLENDING_MIX",[nd]:"ENVMAP_BLENDING_ADD"};function H_(s){return s.envMap===!1?"ENVMAP_BLENDING_NONE":V_[s.combine]||"ENVMAP_BLENDING_NONE"}function G_(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function W_(s,e,t,n){const i=s.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=F_(t),c=B_(t),h=z_(t),d=H_(t),u=G_(t),f=A_(t),g=R_(r),_=i.createProgram();let p,m,x=t.glslVersion?"#version "+t.glslVersion+`
